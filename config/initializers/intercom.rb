IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "27000bf67138a61f88e67135488b0cf08c5380f4"

  # == Intercom secret key
  # This is required to enable secure mode, you can find it on your Intercom
  # "security" configuration page.
  #
  config.api_secret = "GNdQbIzSfBawdZJ5qyfZyQWTNQ__XqCOft67D7IG"
  ...
  config.user.custom_data = {
    ...
    email: :email,
    podcast: Proc.new { |user| user.podcast.name },
  }
